...
# Database
# Use DB_ENGINE env var to select backend. Set DB_ENGINE=postgresql in .env for PostgreSQL.
# Defaults to SQLite so the project always starts.
...
if DB_ENGINE == 'postgresql':
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'Restroscan_db'),
